...
Read `node_modules/next/dist/docs/` before Specializations any Next.js-specific code.
...
- **`expertiseFooterSection`** is a 300 vh sticky section covering 3 scroll steps. Do not split it into separate sections without updating `TOTAL` in `page.js`.
